-- =====================================================
-- Migration: 20251219200002_fix_get_history_summary_column_types
-- Description: Fix column type mismatch in get_history_summary
--
-- Issue: "Returned type character varying does not match expected type text in column 5"
-- - organizations.name is VARCHAR but return type declares TEXT
-- - Need to cast subquery results to TEXT to match declared return type
-- =====================================================
...
BEGIN
  ...
  SELECT
    ...
    a.from_type::VARCHAR,
    a.from_id,
    -- Cast to TEXT to match declared return type
    CASE
