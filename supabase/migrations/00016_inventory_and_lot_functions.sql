-- =====================================================
-- Migration: 00016_inventory_and_lot_functions.sql
...
COMMENT ON FUNCTION get_inventory_summary IS '조직의 제품별 재고 요약을 반환합니다. DB에서 그룹화하여 API limit 제한을 우회합니다.';
...
COMMENT ON FUNCTION add_quantity_to_lot IS '기존 Lot에 추가 수량을 더하고 해당 수량만큼 virtual_codes를 생성합니다.';
...
COMMENT ON FUNCTION upsert_lot IS '동일한 제품+Lot번호가 있으면 수량을 추가하고, 없으면 새로 생성합니다.';
