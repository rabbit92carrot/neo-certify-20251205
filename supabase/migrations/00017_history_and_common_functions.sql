-- =====================================================
-- Migration: 00017_history_and_common_functions.sql
...
COMMENT ON FUNCTION get_history_summary IS '조직의 거래이력을 시간+액션+당사자별로 그룹화하여 반환합니다.';
...
COMMENT ON FUNCTION get_history_summary_count IS '거래이력 그룹의 총 개수를 반환합니다.';
...
COMMENT ON FUNCTION get_organization_names IS '여러 조직 ID에 대한 이름을 일괄 조회합니다.';
...
COMMENT ON FUNCTION get_notification_stats IS '알림 메시지 통계를 한 번의 쿼리로 반환합니다.';
