-- =====================================================
-- Migration: 20251219200003_fix_get_history_summary_bigint_cast
-- Description: Fix total_quantity type mismatch in get_history_summary
--
-- Issue: "Returned type numeric does not match expected type bigint in column 12"
-- - SUM() returns numeric by default
-- - Need to cast SUM result to BIGINT to match declared return type
-- =====================================================
...
COMMENT ON FUNCTION get_history_summary IS 'Returns grouped transaction history with organization names and product codes.';
