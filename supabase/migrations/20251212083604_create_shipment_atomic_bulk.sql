-- Migration: 20251212083604_create_shipment_atomic_bulk
-- Description: Optimized create_shipment_atomic with BULK operations
...
BEGIN
  ...
  LOOP
    ...
    SELECT v_batch_id, UNNEST(v_selected_codes);

    -- BULK UPDATE: ownership
