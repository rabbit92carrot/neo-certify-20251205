...
COMMENT ON FUNCTION get_user_organization_id() IS '현재 로그인 사용자의 조직 ID 반환';
...
COMMENT ON FUNCTION get_user_organization_type() IS '현재 로그인 사용자의 조직 유형 반환';
...
COMMENT ON FUNCTION is_admin() IS '현재 로그인 사용자가 관리자인지 확인';
