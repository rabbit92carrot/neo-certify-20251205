-- Fix get_history_summary_cursor function type mismatch (part 2)
-- Error: "Returned type numeric does not match expected type bigint in column 12"
-- Solution: Add ::BIGINT cast to total_qty
...
COMMENT ON FUNCTION public.get_history_summary_cursor IS '조직별 이력 요약 커서 기반 페이지네이션 (기본 3일, timeout 30s) - bigint cast fix';
